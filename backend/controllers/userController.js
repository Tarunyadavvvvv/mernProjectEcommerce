...
exports.updateProfile = catchAsyncErrors(async (req, res, next) => {
  const newUserData = {
    ...
    email: req.body.email || undefined, // Only update if provided
  };
  ...
  if (req.body.avatar) {
    ...
    const myCloud = await cloudinary.v2.uploader.upload(req.body.avatar, {
      ...
      width: 150,
      crop: "scale",
      quality: "auto:best", // Automatically adjust the quality for optimal results
    });
  ...
  // Remove undefined properties from newUserData
